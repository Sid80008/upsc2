...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // New Theme Colors based on HTML
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Background Mesh/Gradient would go here or just plain surface
          Positioned.fill(
            child: Container(
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: _isLoading
                                      ...
                                      : const Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text('Sign In', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Lexend')),
                                            SizedBox(width: 8),
                              ...
                              Row(
                                children: [
                                  ...
                                  const Padding(
                                    ...
                                    child: Text('OR CONTINUE WITH', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: Colors.grey, letterSpacing: 1)),
                                  ),
                                  Expanded(child: Divider(color: outlineVariant.withValues(alpha: 0.2))),
                                ],
                              ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Text("Don't have an account?", style: TextStyle(color: secondary, fontWeight: FontWeight.w500)),
                        TextButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                          ...
                          child: const Text("Sign Up", style: TextStyle(color: primaryContainer, fontWeight: FontWeight.bold)),
                        ),
                      ],
                    ),
                  ],
